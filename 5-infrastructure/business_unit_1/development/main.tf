...
module "env" {
  ...
  gke_cluster_1_cidr_block     = "100.65.34.0/28" # Cluster control plane same is defined in 3-networks/envs/development/boa_vpc_fw.tf
  gke_cluster_2_cidr_block     = "100.66.34.0/28" # Cluster control plane same is defined in 3-networks/envs/development/boa_vpc_fw.tf
  gke_mci_cluster_cidr_block   = "100.64.70.0/28" # Cluster control plane same is defined in 3-networks/envs/development/boa_vpc_fw.tf
